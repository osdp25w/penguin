...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...
    disabled: (!__VLS_ctx.hasPrevPage),
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...
    disabled: (!__VLS_ctx.hasNextPage),
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.select, __VLS_intrinsicElements.select)({
    ...{ onChange: (...[$event]) => {
            __VLS_ctx.$emit('limit-change', Number($event.target.value));
        } },
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.i, __VLS_intrinsicElements.i)({
    ...{ class: "i-ph-caret-left w-4 h-4" },
});
for (const [page, index] of __VLS_getVForSourceType((__VLS_ctx.pageRange))) {
    (index);
    if (page === -1) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.i, __VLS_intrinsicElements.i)({
    ...{ class: "i-ph-caret-right w-4 h-4" },
});
