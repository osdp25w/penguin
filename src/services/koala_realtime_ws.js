...
function notifySubscribers(updates) {
    if (!updates.length)
        return;
    ...
    try {
        ...
        ws.onmessage = (evt) => {
            try {
                ...
                if ((payload === null || payload === void 0 ? void 0 : payload.type) === 'bike_realtime_status_notification') {
...
export function setRealtimeStatusConnectionCallback(cb) {
