...
const getSiteVehicles = rest.get(api('/sites/:siteId/vehicles'), (req, res, ctx) => {
    ...
    return res(ctx.delay(200), ctx.json(vehicles));
});
// Submit vehicle return
const submitReturn = rest.post(api('/returns'), async (req, res, ctx) => {
    ...
    return res(ctx.delay(800), // Simulate processing time
    ctx.json({
        id: returnId,
...
// Get return history
const getReturns = rest.get(api('/returns'), (req, res, ctx) => {
...
const getReturnStats = rest.get(api('/returns/stats'), (req, res, ctx) => {
...
const deleteReturn = rest.delete(api('/returns/:returnId'), (req, res, ctx) => {
