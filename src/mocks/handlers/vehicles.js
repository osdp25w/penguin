...
// 為地圖API生成站點車輛
function generateVehiclesBySite(siteId) {
    if (!SEED_MOCK_ENABLED) {
        return [];
    }
...
export const vehiclesHandlers = [
    ...
    rest.get('/api/v1/vehicles', (req, res, ctx) => {
        try {
            ...
            if (!siteId) {
                return res(ctx.status(400), ctx.json({ error: 'siteId parameter is required' }));
            }
            const vehicles = generateVehiclesBySite(siteId);
            const delay = faker.number.int({ min: 100, max: 400 });
            return res(ctx.delay(delay), ctx.status(200), ctx.json(vehicles));
        }
        catch (error) {
        ...
        try {
            ...
            if (keyword) {
                ...
                vehicles = vehicles.filter(v => {
                    var _a, _b;
                    return v.id.toLowerCase().includes(lowerKeyword) ||
                        ((_a = v.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(lowerKeyword)) ||
                        ((_b = v.device_id) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(lowerKeyword));
                });
            }
            if (status) {
    ...
    rest.get('/api/v1/metrics/vehicle/:id/battery', (req, res, ctx) => {
        try {
            ...
            return res(ctx.delay(300), ctx.status(200), ctx.json(batteryMetrics));
        }
        catch (error) {
...
export function getDemoVehiclesList(filters) {
    const allData = generateNewVehicleData();
    let vehicles = allData.vehicles;
    if (filters === null || filters === void 0 ? void 0 : filters.siteId) {
    ...
    if (filters === null || filters === void 0 ? void 0 : filters.keyword) {
        ...
        vehicles = vehicles.filter(v => {
            var _a, _b;
            return v.id.toLowerCase().includes(kw) ||
                (((_a = v.name) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || '').includes(kw) ||
                (((_b = v.device_id) === null || _b === void 0 ? void 0 : _b.toLowerCase()) || '').includes(kw);
        });
    }
    if (filters === null || filters === void 0 ? void 0 : filters.status) {
        vehicles = vehicles.filter(v => v.status === filters.status);
    }
    if ((filters === null || filters === void 0 ? void 0 : filters.soh_lt) != null) {
