...
function generateMockVehicle(siteId, index) {
    const statuses = ['available', 'rented', 'maintenance', 'charging'];
    const brands = ['huali', 'shunqi'];
...
function generateVehicles(siteId) {
