            ...
            try {
                ...
                try {
                    ...
                    if (response && response.code === 2000) {
                        const results = ((_a = response.data) === null || _a === void 0 ? void 0 : _a.results) || response.data || [];
                ...
                try {
                    ...
                    if (response && response.code === 2000) {
                        ...
                        const siteAlerts = results
                            .filter((item) => {
                            var _a;
                            const bike = ((_a = item.error_log) === null || _a === void 0 ? void 0 : _a.bike) || {};
        ...
        async fetchAlertsPaged(params) {
            ...
            try {
                ...
                try {
                    ...
                    if (filterParams.is_read !== undefined)
                        queryParams.append('is_read', String(filterParams.is_read));
