...
export async function ensureOrt() {
    ...
    if (!ortReady) {
        ortReady = new Promise((resolve, reject) => {
            ...
            tryLoad('https://cdn.jsdelivr.net/npm/onnxruntime-web@1.20.0/dist/ort.min.js', () => tryLoad('https://cdn.jsdelivr.net/npm/onnxruntime-web@1.20.0/dist/ort.web.min.js'));
        });
    }
    try {
...
// 創建序列化執行的包裝函數
async function runSessionWithLock(sessionKey, runFn) {
    // 如果有正在執行的任務，等待它完成
    ...
    sessionLocks[sessionKey] = new Promise(resolve => {
        releaseLock = () => resolve();
    });
    try {
...
export async function runSession(sess, feeds) {
    ...
    const sessionKey = ((_a = sess.handler) === null || _a === void 0 ? void 0 : _a._sessionId) || 'default';
