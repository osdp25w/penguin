...
router.beforeEach((to) => {
    var _a, _b, _c, _d;
    const auth = useAuth();
    const requiresAuth = to.matched.some(route => { var _a; return (_a = route.meta) === null || _a === void 0 ? void 0 : _a.requiresAuth; });
    const requiresAdmin = to.matched.some(route => { var _a; return (_a = route.meta) === null || _a === void 0 ? void 0 : _a.requiresAdmin; });
    const allowedRolesMeta = to.matched.flatMap(route => { var _a, _b; return (_b = (_a = route.meta) === null || _a === void 0 ? void 0 : _a.allowedRoles) !== null && _b !== void 0 ? _b : []; });
    const memberOnly = to.matched.some(route => { var _a; return (_a = route.meta) === null || _a === void 0 ? void 0 : _a.memberOnly; });
    const currentRole = (((_a = auth.user) === null || _a === void 0 ? void 0 : _a.roleId) || sessionStorage.getItem('penguin.role') || localStorage.getItem('penguin.role'));
    ...
    if (requiresAdmin) {
        let role = (_b = auth.user) === null || _b === void 0 ? void 0 : _b.roleId;
        if (!role)
    ...
    /* 設定頁面標題（如果還沒設定） */
    const titleFromMatched = (_d = (_c = to.matched.slice().reverse().find(route => { var _a; return (_a = route.meta) === null || _a === void 0 ? void 0 : _a.title; })) === null || _c === void 0 ? void 0 : _c.meta) === null || _d === void 0 ? void 0 : _d.title;
    if (titleFromMatched) {
