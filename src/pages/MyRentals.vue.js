...
const userRole = computed(() => { var _a; return ((_a = auth.user) === null || _a === void 0 ? void 0 : _a.roleId) || sessionStorage.getItem('penguin.role') || localStorage.getItem('penguin.role'); });
...
if (__VLS_ctx.loading) {
    ...
    for (const [rental] of __VLS_getVForSourceType((__VLS_ctx.rentals))) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
            ...{ onClick: (...[$event]) => {
                    if (!!(__VLS_ctx.loading))
                        return;
...
if (__VLS_ctx.selectedRental) {
    ...
    if (__VLS_ctx.detailLoading) {
        ...
        (((_d = __VLS_ctx.selectedRental.bike) === null || _d === void 0 ? void 0 : _d.bike_name) || ((_e = __VLS_ctx.selectedRental.bike) === null || _e === void 0 ? void 0 : _e.bike_id));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
        __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
            ...{ class: "text-gray-500" },
        });
