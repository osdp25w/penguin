...
<template>
  ...
  <div class="fixed inset-0 -z-20 overflow-hidden bg-slate-950">
    ...
    <div
      class="absolute -top-1/3 -left-1/4 w-[180%] h-[180%] rotate-45
             bg-gradient-to-tr from-indigo-600/5 via-fuchsia-600/10 to-teal-500/5" />
  </div>
  ...
  <div class="relative mx-auto max-w-screen-2xl px-10 py-10 space-y-10">
    ...
    <div class="flex justify-end">
      <button class="btn bg-rose-600 hover:bg-rose-500" @click="logout">
        登出
      </button>
    </div>
...
const socLabels  = ['00h','02h','04h','06h','08h','10h','12h','14h',
                    '16h','18h','20h','22h']
